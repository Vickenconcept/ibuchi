                ...
                <div class="">
                    <div class="2xl:col-span-3 lg:col-span-2 bg-white border text-faded shadow-lg rounded-xl p-6">
                        <div class="py-3 flex items-start justify-start">
                            <h1 class="text-dark font-semibold text-2xl">Edit Service</h1>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 w-full">
                            <div class="">
                                ...
                                <x-text-input type="text" id="service_name" name="name" class="w-full"
                                    value="{{ old('name', $service->name) }}"  placeholder="Service Name Here" />
                            </div>
                            ...
                            <div class="">
                                ...
                                <x-select-input class=" w-full" name="type" id="type">
                                    ...
                                    <option value="cleaning" @selected(old('type', $service->type) == 'cleaning')>Cleaning</option>
                                    <option value="task" @selected(old('type', $service->type) == 'task')>Task</option>
                                    </x-my-select-input>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <textarea id="summernote" name="description" rows="8"
                                    class="w-full border-gray-300 focus:border-secondary-500 focus:ring-secondary-500 rounded-md shadow-sm">{!! old('description', $service->description) !!}</textarea>
                            </div>
